...
function ram_use {
    ...
    Invoke-Command -ScriptBlock { Get-ComputerInfo | Select-Object @{Name = "RAM Libre en MB"; Expression = { ("{0:F2}" -f ($_.OsFreePhysicalMemory / 1MB) ) } } } -Session $session | Tee-Object $info_log -Append
